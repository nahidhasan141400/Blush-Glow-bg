"use strict";(self.webpackChunkbag_api=self.webpackChunkbag_api||[]).push([[7992],{7992:(U,v,s)=>{s.r(v),s.d(v,{default:()=>ct});var t=s(74081),o=s(15530),c=s(59461),x=s(38178),l=s(27279),S=s(51926),D=s(27997),L=s(73354),p=s(27875),r=s(37472),g=s(32370),y=s(48102),q=s(74758),k=s(93415),_=s(70774),tt=s(38566),st=s(38101),F=s(93153),d=s(50086),K=s(73411),et=s(10989),nt=s(86967),P=s(10701),w=s(19003);const $=w.ZP.div`
